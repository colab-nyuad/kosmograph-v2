...
import { LinkTypes } from "../linkTypes";  // Import LinkTypes

const SidebarTabs = ({ linkTypeColors }: { linkTypeColors: Record<string, string> }) => {  // Receive linkTypeColors as a prop
                ...
                <div className="flex-1">
                    <div className="pt-2 pb-4 space-y-1 text-sm">
                        <Accordion type="multiple">
                            <SidebarNodeTab />
                            <SidebarLinkTab />
                            <LinkTypes linkTypes={linkTypeColors} onToggle={() => { }} />  {/* Pass linkTypeColors */}
                        </Accordion>
                    </div>
                </div>
            </TabsContent>
